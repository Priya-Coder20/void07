...
const { createStudent, createStaff, createAdmin, getUsers, deleteUser, checkEmail, updateUser } = require('../controllers/userController');
...
router.route('/:id').delete(protect, authorize('admin'), deleteUser).put(protect, authorize('admin'), updateUser);
